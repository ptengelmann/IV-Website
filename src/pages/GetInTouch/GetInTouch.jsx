...
const GetInTouch = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Grid Layout with Four Boxes */}
      <div className={styles.fourBoxLayout}>
        <div className={styles.container}>
          {/* Top Row: Form and Brands */}
          <div className={styles.gridRow}>
            ...
            <div className={styles.gridBox}>
              <div className={styles.brandCard}>
                <h2 className={styles.brandTitle}>Trusted by leading brands</h2>
                ...
                <div className={styles.brandMessage}>
                  <p>Join over 200+ businesses that have transformed their digital presence with us</p>
          ...
          {/* Bottom Row: Core Services and Contact Info */}
          <div className={styles.gridRow}>
            {/* Core Services Box */}
            <div className={styles.gridBox}>
                ...
                <div className={styles.servicesList}>
                  {servicePillars.map((pillar) => (
                    <div 
                      ...
                      style={{ '--service-color': pillar.color }}
                    >
            ...
            <div className={styles.gridBox}>
              <div className={styles.contactCard}>
                <h2 className={styles.contactTitle}>How We Can Help</h2>
                ...
                <div className={styles.workingHours}>
                  ...
                  <div className={styles.hoursGrid}>
                    <div className={styles.hoursItem}>
                      ...
                      <span className={styles.timeLabel}>9:00 AM - 5:30 PM</span>
                    </div>
                    <div className={styles.hoursItem}>
                      <span className={styles.dayLabel}>Saturday - Sunday</span>
                      <span className={styles.timeLabel}>Closed</span>
                    </div>
                  </div>
                </div>
                
                <div className={styles.contactButtons}>
                  <a href="tel:+441529300452" className={styles.contactButton}>
                    <Phone size={16} />
                    <span>Call Now</span>
                  </a>
                  <a href="mailto:customerservices@iv-creative.co.uk" className={styles.contactButton}>
                    <Mail size={16} />
                    <span>Email Us</span>
                  </a>
                </div>
